...
var startYr = 2000;
  var endYr = 2000; //** Chose 2019 because it is the last full year of data at this point
...
var startDate = ee.Date.fromYMD(startYr,3,1); //*NOTE: March 2000 is the first full month of LST available
print('startDate',startDate)
var endDate = ee.Date.fromYMD(endYr+1,3,1); //**NOTE: the end date in .filterDate() is *exclusive
...
print('perYrMonthly',perYrMonthly);
